      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3">
        <template v-for="(item, i) in liveAttendenceList" :key="i">
          <div class="col" :style="`order:${-i}`">
            <div
              class="attendance-card shadow-sm"
              :class="{
            ...
            >
              ...
              <ul class="list-unstyled mb-2">
                ...
                <li><strong>Late:</strong> {{ item?.late_in_minute || 0 }} min</li>
                <li><strong>Shift:</strong> {{ item?.shift_duration }}</li>
                <li>
                  <strong>Date:</strong> {{ Ahelper.printDate(item) }}
                </li>
                <li>
              ...
              <div v-if="item?.remarks" class="remarks small">
                “{{ item.remarks }}”
              </div>
            </div>
          </div>
