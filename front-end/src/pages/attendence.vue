  ...
  <div class="page-contents">
    <div id="REPORTING_TAB_AREA" class="d-flex justify-content-between align-items-start">
      <ul class="nav nav-tabs mt-0 mb-3 bottom-borderless">
         <li class="nav-item">
           <a @click.stop="tab = 1" @auxclick="log(log({tab}))" @auxclick.stop="clearAllAndRelaod()" class="nav-link cp text-black" :class="{'active': tab == 1}">
         ...
         <li class="nav-item">
           <a @click.stop="tab = 5" @auxclick="log(log({tab}))" class="nav-link cp text-black" :class="{'active': tab == 5}">
         ...
         <li class="nav-item">
           <a @click.stop="tab = 3" @auxclick="log(log({tab}))" class="nav-link cp text-black" :class="{'active': tab == 3}">
         ...
         <li class="nav-item">
           <a @click.stop="tab = 4" @auxclick="log(log({tab}))" class="nav-link cp text-black" :class="{'active': tab == 4}">
         ...
         <li class="nav-item">
           <a @click.stop="tab = 2" @auxclick="log(log({tab}))" class="nav-link cp text-black" :class="{'active': tab == 2}">
