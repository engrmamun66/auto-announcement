  ...
  <div class="page-contents">
    <div id="REPORTING_TAB_AREA" class="d-flex justify-content-between align-items-start">
      <ul class="nav nav-tabs mt-0 mb-3 bottom-borderless">
         <li class="nav-item">
           <a @click.stop="handleTabChange(1)" @auxclick="log({tab}, 'RealtimeAttendences.vue')" @auxclick.stop="clearAllAndRelaod()" class="nav-link cp text-black" :class="{'active': tab == 1}">
         ...
         <li class="nav-item">
           <a @click.stop="handleTabChange(5)" @auxclick="log({tab}, 'HaziraKhata.vue')" class="nav-link cp text-black" :class="{'active': tab == 5}">
         ...
         <li class="nav-item">
           <a @click.stop="handleTabChange(4)" @auxclick="log({tab}, 'Reporting.vue')" class="nav-link cp text-black" :class="{'active': tab == 4}">
         ...
         <li class="nav-item">
           <a @click.stop="handleTabChange(3)" @auxclick="log({tab}, 'WeekendAndHolidays.vue')" class="nav-link cp text-black" :class="{'active': tab == 3}">
         ...
         <li class="nav-item">
           <a @click.stop="handleTabChange(2)" @auxclick="log({tab}, 'AttendencesAll.vue')" class="nav-link cp text-black" :class="{'active': tab == 2}">
      ...
      <div v-else-if="tab == 2">
        <div class="d-flex flex-wrap justify-content-center align-items-center gap-2">
          ...
          <div class="form-group" :tooltip="helper.t('Sort By')">
          ...
          <div class="form-group" :tooltip="helper.t('Sort Direction')">
          ...
          <div class="form-group" :tooltip="helper.t('Per Page')">
      ...
      <div v-else-if="tab == 3">
        ...
        <div class="d-flex justify-content-end column-gap-3">
          <ul class="nav nav-tabs d2 mt-0 mb-3 bottom-borderless">
            <li class="nav-item">
              <a @click.stop="leaveAndWeekendSubTab = 1" class="nav-link cp text-black" :class="{'active': leaveAndWeekendSubTab==1}" >{{ helper.t('Class Wise') }}</a>
            </li>
            <li class="nav-item">
              <a @click.stop="leaveAndWeekendSubTab = 2" class="nav-link cp text-black" :class="{'active': leaveAndWeekendSubTab==2}" >{{ helper.t('Student Wise') }}</a>
            </li>       
          </ul>
        </div>
